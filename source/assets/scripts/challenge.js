...
const recipes = [
  ...
  'assets/jsons/recipeTemplate.json'
];

const recipeData = {};

const router = new Router(() => {
  document.querySelector('.section--challenge-page').classList.add('shown');
...
function createRecipeCards() {
  for (let i = 0; i < recipes.length; i += 1) {
    ...
    router.addPage(page, () => {
      document.querySelector('.section--challenge-page').classList.remove('shown');
